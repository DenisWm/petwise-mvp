 ...
 *
 * <p>Use this for fire-and-forget operations where the caller only needs to know that the
 * command succeeded (e.g., "Delete Tutor"). The absence of a return value signals that the
 * operation is purely side-effectful.
 *
