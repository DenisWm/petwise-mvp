 ...
 * represents a single, well-defined business operation (e.g., "Create Tutor"). Implementations
 * must be free of infrastructure concerns — they interact with the domain model and
 * delegate persistence to a gateway interface.
 *
