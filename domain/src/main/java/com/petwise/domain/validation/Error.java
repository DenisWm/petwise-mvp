 ...
 *
 * <p>Instances are produced by validators and collected by a {@link ValidationHandler}.
 * They are also carried inside domain exceptions so that the presentation layer can display
