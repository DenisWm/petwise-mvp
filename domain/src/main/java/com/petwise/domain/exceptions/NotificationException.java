 ...
 * execution.
 *
 * <p>It wraps a {@link Notification} so that all accumulated errors are accessible through
 * {@link #getErrors()}, enabling the presentation layer to return detailed feedback to the caller.
 */
public class NotificationException extends DomainException {

    /**
     * Constructs a {@code NotificationException} with a descriptive message and the
     * {@link Notification} that contains all collected errors.
     *
     * @param message      a high-level description of what failed (e.g., "Could not create Tutor")
