...
/**
 * Custom {@link AccessDeniedHandler} that delegates to the Spring MVC {@link
 * HandlerExceptionResolver} chain, so that security-related 403 errors are handled by {@link
